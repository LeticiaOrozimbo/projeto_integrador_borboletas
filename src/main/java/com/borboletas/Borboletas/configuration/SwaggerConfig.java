package com.borboletas.Borboletas.configuration;
...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Borboletas", "https://github.com/LeticiaOrozimbo/ProjetoIntegrador_Borboletas", "lucaslauro@live.com");
	}
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.borboletas.Borboletas.controlador"))
